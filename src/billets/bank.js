...
var rootFactorDate = moment_1.default("07-10-1997", "DD-MM-YYYY").utcOffset("America/Sao_Paulo");
exports.rootFactorDate = rootFactorDate;
var firstFactorDate = moment_1.default("03-07-2000", "DD-MM-YYYY").utcOffset("America/Sao_Paulo");
exports.firstFactorDate = firstFactorDate;
var BankBillet = /** @class */ (function () {
    ...
    BankBillet.createBillet = function (value, expiry, bank) {
        ...
        var passedDaysFromFactor = today.diff(firstFactorDate, "days") + Number(expiry);
    ...
    BankBillet.bankDate = function (due) {
        var today = moment_1.default().utcOffset("America/Sao_Paulo");
        // Calculates the current, previous and next factor dates based on the current date
        var passedDaysFromFactor = today.diff(firstFactorDate, "days");
