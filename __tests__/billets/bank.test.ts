...
describe("Test bank billet creation", () => {
  ...
  it("Create invalid billet", () => {
    MockDate.set("2020-01-01T12:00:00-0300");
    expect(() => BankBillet.createBillet(123, 10, "xxx")).toThrowError("Invalid parameters");
  });
});
...
describe("Test bank billet parser", () => {
  it("Invalid barcode", () => {
    expect(() => BankBillet.parseBillet("23791880300000010000007000000000000000000000"))
      .toThrowError("Invalid barcode");
  });

  it("Invalid line", () => {
    expect(() => BankBillet.parseBillet("93790000090000000000000000000000281310000012300"))
      .toThrowError("Invalid line");
  });

  it("Billet format error", () => {
    expect(() => BankBillet.parseBillet("237918803000000100000xxxx00000000000000000")).toThrowError("Billet format error");
  });
